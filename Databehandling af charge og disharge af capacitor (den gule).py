...
#Til mikroskeunder og sæt start til 0
...
plt.plot(t, V_discharge, color = 'red', label="Discharging theoretical")
plt.plot(discharge['Time (µs)'], discharge['Channel 2 (V)'], color="yellow", label="Discharging experimental")
plt.xlabel("Time (µs)")
